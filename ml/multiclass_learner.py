...
from experiment_configs.schemas import SupervisedFinetuningConfig, SupervisedTrainingConfig, BackpropLossChoice, FinetuningStratagyChoice
...
class MultiSegmentationLearner(ABC):
    """
    ...
    def __init__(self,
                 ...
                 three_class_method = None,
                 ):
        self.config = config
        self.three_class_method = three_class_method
    ...
    def validate_end(self, outputs, num_samples):
        ...
        metrics = {
            **conf_mat_metrics,
            ...
            "val_ce_loss": val_ce_losses.cpu().numpy().sum() / num_samples,
        }
        return metrics
